...
OFFER_LIST = 'https://portal.immobilienscout24.de/ergebnisliste/88206862?wmode=transparenartt'


class KommInKiez(Crawler):
    ...
    def get_offer(self, link: str) -> Offer:
        ...
        offer = Offer(
            ...
            link=link,
            rent={
                'price': int(prize_search.group()) if prize_search else 0,
                'total': True
            },
